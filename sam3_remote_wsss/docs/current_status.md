...
六父图稳定性检查已通过：V2-a 对全部 `6/6` 父图的 mIoU、mF1 和 OA 均为正增益。父图
宏平均 mIoU/mF1/OA 从 `0.3406/0.4471/0.3933` 提高到
`0.3688/0.4805/0.4314`，mIoU/mF1/OA 标准差从 `0.0450/0.0438/0.0839` 降到
`0.0353/0.0298/0.0629`。V2-a 至此冻结为机制消融，不再调整 allowlist 或 margin；下一阶段
